...
import type { ErrorCategory } from './errorCategorizer';
...
export const OPENSCAD_PITFALLS: OpenSCADPitfall[] = [
  ...
  // ============================================
  {
    ...
    description:
      'When using difference(), the cutting geometry must extend PAST the base object on both sides. If it only touches the surface, the result may be empty or have z-fighting artifacts.',
...
difference() {
  ...
  },
  {
    ...
    description:
      'Coincident faces (faces touching exactly) cause undefined behavior. Always use a small epsilon offset to ensure clean boolean operations.',
...
union() {
  ...
  },
  {
    ...
    description:
      'Non-manifold geometry (edges shared by >2 faces, zero-thickness walls, T-junctions) makes models unprintable. The Manifold Guard enforces three rules: (1) epsilon on ALL difference() cuts, (2) hull() for connectivity instead of edge alignment, (3) no coincident faces between union() children.',
...
hull() {
  ...
  },
  {
    ...
    description:
      'When connecting two parts, use hull() with keyframe primitives instead of relying on exact coordinate math. hull() guarantees a watertight solid between any two convex shapes, eliminating manifold errors at joints.',
...
module elbow(d=10, len=20) {
  ...
  // ============================================
  {
    ...
    description:
      'OpenSCAD processes variables at compile-time. All variables must be defined BEFORE they are used. The "last assignment wins" globally.',
...
cube([width, height, depth]);`,
  ...
  },
  {
    ...
    description:
      'OpenSCAD variables cannot be modified after assignment. Each "assignment" is actually a new declaration, and the LAST one wins globally.',
...
y = increment(x);  // y is 6`,
  ...
  // ============================================
  {
    ...
    description:
      'Custom modules must be defined before they are called. Place module definitions at the top of your file.',
...
my_part();`,
  ...
  },
  {
    ...
    description:
      'Parameters passed to a module only exist inside that module. They cannot be accessed from outside or from other modules.',
...
echo(size);  // Works: size is global`,
  ...
  // ============================================
  {
    ...
    description:
      'Transformations apply RIGHT TO LEFT (innermost operation first). translate() then rotate() produces different results than rotate() then translate().',
...
translate([20, 0, 0])
  ...
  // ============================================
  {
    ...
    description:
      'Every statement in OpenSCAD must end with a semicolon. This includes variable assignments, module calls, and standalone primitives.',
...
cube([width, height, 5]);`,
  ...
  },
  {
    ...
    description:
      'Every opening brace { must have a matching closing brace }. Module definitions, boolean operations, and for loops all require braces.',
...
module box() {
  ...
  // ============================================
  {
    ...
    description:
      'Recursive modules must have a termination condition that stops the recursion. Without it, OpenSCAD will crash with stack overflow.',
...
recursive_part(10);`,
  ...
  // ============================================
  {
    ...
    description:
      'When using rotate_extrude(), the 2D shape must be translated AWAY from the Y-axis (along X). Shapes crossing the Y-axis create invalid geometry.',
...
rotate_extrude()
  ...
  // ============================================
  {
    ...
    description:
      'For FDM 3D printing, walls must be at least 1.2mm thick (3 perimeters with 0.4mm nozzle). Thinner walls may not print or will be fragile.',
 ...
 */
export function formatPitfallGuidance(
  pitfalls: OpenSCADPitfall[],
