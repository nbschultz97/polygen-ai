...
- **Engineering Cognition**: Planner now uses Topological Design Patterns (Adapter Boss for flat-to-round connections, Hull Heuristic for cross-section transitions, Manifold Hole rule for clean subtractions)
- **Sovereign Engineering Doctrine**: Formalized Local First, Vendor Neutral, Manifold Guaranteed philosophy in TECHNICAL_STRATEGY.md
- **Hardware Copilot Roadmap**: Added forward-looking strategic phases (MCP Server, Visual-RFT, Anti-OnShape positioning)
