...
const App: React.FC = () => {
  ...
  // Image upload hook
  const { attachedImage, imagePreview, handleImageUpload, clearAttachedImage } = useImageUpload();
  ...
  return (
    <ErrorBoundary>
      <div className="flex flex-col h-screen bg-[#09090b] text-gray-100 font-sans">
        <AppHeader useMultiAgent={USE_MULTI_AGENT} onOpenSettings={() => setShowSettings(true)} />
